...
<body>
  ...
  <section class="contact_section layout_padding">
    <div class="container">
      ...
      <p class="text-center">
        Si quieres saber o agregar algo mas, en nuestra casilla de mensaje dejanoslo saber.
              ...
              <?php
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <input name="nombre" type="text" class="form-control" id="nombnre" aria-describedby="emailHelp">
                  </div>

                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Asunto:</label>
                    <input name="asunto" type="text" class="form-control" id="asunto" aria-describedby="emailHelp">
                  </div>

                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Comentario</label>
                    <input name="comentario" type="text" class="form-control" id="asunto" aria-describedby="emailHelp">
                  </div>
